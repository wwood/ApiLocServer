...
ActiveRecord::Schema.define(:version => 20090820062244) do
  ...
  add_index "proteomic_experiment_peptides", ["charge", "coding_region_id", "peptide", "proteomic_experiment_id"], :name => "index_proteomic_experiment_peptides_on_coding_region_id_and_pro", :unique => true
